<template>
<div class="sign">
    <div class="logo"><a href="/"><img src="/static/image/liveshare.png" alt="Logo"></a></div>
    <div class="main">
      <h4 class="title">
      ...
      <div class="js-sign-up-container">
        <form class="new_user" id="new_user" action="" accept-charset="UTF-8" method="post">
          <div class="input-prepend restyle">
              <input placeholder="手机号" type="text" value="" v-model="mobile" id="user_nickname">
          ...
          <div class="input-prepend">
            <input placeholder="设置新密码" type="password" v-model="password" id="user_password">
            <i class="iconfont ic-password"></i>
          </div>

          <div class="input-prepend">
            <input placeholder="确认新密码" type="password" v-model="password2" >
            <i class="iconfont ic-password"></i>
          </div>
          <input type="submit" name="commit" value="重置密码" class="sign-up-button" id="sign_up_btn" @click.prevent="registerHandler">
    ...
    export default {
        ...
        methods:{
           registerHandler(){
            ...
            // 手机修改密码处理
            this.$axios.post(`${this.$settings.Host}/users/find/password/mobile/`,{
                mobile: this.mobile,
