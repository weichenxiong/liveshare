...
<!--&lt;!&ndash;         <div class="image-view" data-width="640" data-height="420">&ndash;&gt;-->
<!--&lt;!&ndash;          <img :src="article.article_image" />&ndash;&gt;-->
<!--&lt;!&ndash;         </div>&ndash;&gt;-->
<!--        </div>-->
    ...
    export default {
        ...
        methods:{
           ...
           get_article(){
            ...
            this.$axios.get(`${this.$settings.Host}/article/article_info/${this.article_id}/`).then(response=>{
...
.ant-click-animating-node,[ant-click-animating-without-extra-node=true]:after {
	...
	-webkit-box-shadow: 0 0 0 0 #ec7259;
	box-shadow: 0 0 0 0 #ec7259;
...
@-webkit-keyframes waveEffect {
	to {
		-webkit-box-shadow: 0 0 0 #ec7259;
		box-shadow: 0 0 0 #ec7259;
		-webkit-box-shadow: 0 0 0 6px #ec7259;
		box-shadow: 0 0 0 6px #ec7259;
